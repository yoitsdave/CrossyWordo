...
#will output a json mapping of the following:
#width: width int
#height: height int
...
if __name__ == "__main__":
    ...
    counter = 0
    while loaded_puz.is_solution_locked():
        loaded_puz.unlock_solution(counter)
        counter += 1
